      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" title="Geral" href="<?=url('colaborador');?>">Geral</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" title="Meus Pedidos" href="<?=url('colaborador/meus-pedidos');?>">Meus Pedidos</a>
            </li>
            <li class="nav-item">
